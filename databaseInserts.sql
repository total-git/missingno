...
insert into Item (id,item_description,name,use_action,takeable,area_id) values (3,"A statue of the greek god Zeus","zeus","examine",0,3);
insert into Item (id,item_description,name,use_action,takeable,area_id) values (4,"A lightning. Who could use such a thing?","lightning","pick up,use with",1,3);
